...
public class BranchTSP {
    ...
    public static void main(String[] args) {
        ...
        numOfVertex = scanner.nextInt(); // 정점의 갯수 n
        int numOfEdge = scanner.nextInt(); // 간선의 갯수 n

        int[][] graph = makeGraph(scanner,numOfVertex,numOfEdge); // Adjacency List 만들기
    ...
    static int[][] makeGraph(Scanner scanner, int size, int numOfEdge){
        ...
        for(int i = 0; i < numOfEdge; i++){
            ...
            graph[row][col] = scanner.nextInt(); // Weighted! 그리고 Directed Graph
        }
        return graph;
    }
